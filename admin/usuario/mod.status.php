<?php
 ...
 $sql_guarda = "SELECT ${var['pre']}_nome ,${var['pre']}_status FROM ".TABLE_PREFIX."_${var['table']}";
 ...
 if ($ok) {
	 ...
	 $sql_status  = "UPDATE ".TABLE_PREFIX."_${var['table']} SET ${var['pre']}_status=${novoStatus}";
