<?php
 ...
 $sql_field = 'ram_adm_id';
 $sql_guarda = "SELECT ram_id id,$sql_field field FROM ".TABLE_PREFIX."_r_adm_mod WHERE ram${res['ref']}=?";
  ...
  */
    echo $num;
       ...
       $sql_rem = "DELETE FROM ".TABLE_PREFIX."_r_adm_mod WHERE ram_id=?";
