...
$include_css = <<<end
     ...
     <link href="${rp}js/inputlimiter.1.0.css" rel="stylesheet" type="text/css" />
     <style>
       div.growlUI { 
...
<!--    <script type="text/javascript" src="${rp}js/tinymce/jscripts/tiny_mce/jquery.tinymce.js"></script>-->
    ...
    <script type="text/javascript" src="${rp}js/jquery.inputlimiter.1.2.min.js"></script>
